...
- With the LED wired, the assistant lights it while the button is pressed and turns it off on release. Flip `BUTTON_LED_ACTIVE_HIGH` if your wiring expects inverted logic.
